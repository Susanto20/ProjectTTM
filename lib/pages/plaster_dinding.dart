...
class PlasterDinding extends StatefulWidget {
  const PlasterDinding({Key? key}) : super(key: key);

  @override
  _PlasterDindingState createState() => _PlasterDindingState();
}

class _PlasterDindingState extends State<PlasterDinding> {
  @override
